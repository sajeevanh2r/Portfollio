        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {referencesData.map((ref, idx) => (
            <TiltCard key={idx} maxTilt={6} scale={1.02} className="h-full">
              <div className="glass-panel p-8 rounded-3xl border border-white/10 hover:border-cyan-500/40 transition-all flex flex-col justify-between shadow-xl relative overflow-hidden group h-full">
                <div>
